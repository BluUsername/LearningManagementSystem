...
Environment-specific overrides live in `dev.py` and `prod.py`. Pick which
one to load with the `DJANGO_SETTINGS_MODULE` environment variable, e.g.
`DJANGO_SETTINGS_MODULE=lms_project.settings.prod`.
"""
